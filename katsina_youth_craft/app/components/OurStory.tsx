...
export default function OurStory() {
    return (
        <section className=" w-full flex flex-col md:flex-row items-center gap-6 py-24 md:py-44 px-[3%] font-league-spartan bg-white text-black " >
            ...
            <div className=" h-[300px] md:h-[400px] lg:h-[420px] bg-gray-400 w-full basis-1/2 flex items-center justify-center " >
