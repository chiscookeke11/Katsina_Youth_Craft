    ...
    return (
        <section className="w-full bg-white py-24 px-[4%] flex items-center flex-col gap-10 font-league-spartan  " >
            ...
            <div className=" w-full max-w-2xl text-center flex items-center justify-center flex-col gap-8  " >
                <p className=" text-lg md:text-xl font-medium leading-[140%] text-gray-900   " >
                ...
                <p className=" text-lg md:text-xl font-normal leading-[140%] text-gray-700   ">Through these diverse skill areas, we ensure that every trainee gains the knowledge, confidence, and experience needed to build a sustainable career and contribute meaningfully to their community.</p>
            </div>
            ...
            {/* Our solutions */}
            <h1 className="text-2xl md:text-5xl font-semibold mt-10 " >Our <span className="text-red-500" >Solutions</span></h1>

            <div className=" w-full max-w-2xl text-center flex items-center justify-center flex-col gap-8  " >
                <p className=" text-lg md:text-xl font-normal leading-[140%] text-gray-700   ">Partnering with strategic players in the private/public sectors, we are able to drive social impact across our focus areas through the following programs.</p>
            </div>
