...
export default function SolutionCard({ data }: solutionCardProps) {
    return (
        <div className=" w-full max-w-sm h-[200px] bg-gray-400 relative group rounded-tl-[70px] rounded-br-[70px]  hover:rounded-none transition-all duration-400 ease-in-out overflow-hidden  " >
            ...
            <Image src={data.image} alt="hero-image" height={1000} width={1000} className="w-full h-full absolute object-cover translate-y-[10%] scale-[130%] group-hover:translate-0 transition-all duration-400 ease-in-out " />
            ...
            <div className=" bg-black/15 absolute top-0 left-0 h-full w-full " />
        </div>
    )
}